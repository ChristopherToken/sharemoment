...
<body>
    ...
    <body>
        ...
        <nav class="navbar fixed-top navbar-expand-lg navbar-dark">
            <div class="container">
                <a class="navbar-brand" href="/responsive_event_html_template_bootstrap_4.html">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-link">
                            <div class="dropdown">
                                <button class="btn btn-secondary dropdown-toggle btn-register" type="button" id="dropdownMenu2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                         More
                                        </button>
